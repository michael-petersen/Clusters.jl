...
functions to compute conserved quantities in spherical systems:
Energy, E
Angular momentum, L

Both functions include switches to flip to the epicyclic approximation when orbits become too circular
-The switching tolerance, in eccentricity, may be defined.

MSP 07 Feb 2022 introduction

TODO:
redefine function names to be easier?


=#

# don't need this include because already coming in a level above
